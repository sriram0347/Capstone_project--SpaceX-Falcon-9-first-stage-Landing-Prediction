...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site_dropdown',options=[{'value': x, 'label': x} 
                                ...
                                dcc.RangeSlider(id='payload_slider',min=0, max=10000, step=1000,
                                                marks={0: '0 Kg',2500: '2500 Kg',5000: '5000 Kg',7500: '7500 Kg',10000: '10000Kg'},
...
def get_pie_chart(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        ...
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == site_dropdown], 
                    names = 'class',title = 'Total Success Launches for site '+site_dropdown)
